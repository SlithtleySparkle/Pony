...
public class MagicMetaballSpaceObj : MonoBehaviour
{
    ...
    {
        [Tooltip("最多13个，不够需要在代码里修改。本物体应当是挂载了MagicMetaball的物体的子物体")]
        //若要修改
    ...
    private MagicMetaball magicMetaball;

    void Start()
    {
        magicMetaball = FindFirstObjectByType<MagicMetaball>().GetComponent<MagicMetaball>();
    ...
    {
        PointClear();
        magicMetaball.isFindMBObj = true;
    }
