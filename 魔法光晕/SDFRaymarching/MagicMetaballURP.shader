        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                rimLight = lerp(0.25, 1, rimLight);
                    ...
                    //侧面有问题
                    float3 falseNor = normalize(i.positionWS - centerPos);
                    ...
                    float cdotDn1 = 1 - saturate(dot(conColOTDirWS, falseNor) + 1);
                    ...
                    float cdotDn2 = 1 - saturate(dot(-conColOTDirWS, falseNor) + 1);
